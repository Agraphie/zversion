...
printf "\n"
printf "'CVE-2012-1180 (0.1.0 - 1.1.16)'; `jq '.Agents[] | select(.Vendor=="nginx" and .CanonicalVersion >= "0000000100000000" and .CanonicalVersion <= "0001000100160000" and .Version != "") | .Version' $tmpName | wc -l`"
printf "\n"
printf "'CVE-2009-3555 (0.1.0 - 0.8.22)'; `jq '.Agents[] | select(.Vendor=="nginx" and .CanonicalVersion >= "0000000100000000" and .CanonicalVersion <= "0000000800220000" and .Version != "") | .Version' $tmpName | wc -l`"
printf "\n"
printf "'CVE-2009-2629 (0.1.0 - 0.8.14)'; `jq '.Agents[] | select(.Vendor=="nginx" and .CanonicalVersion >= "0000000100000000" and .CanonicalVersion <= "0000000800140000" and .Version != "") | .Version' $tmpName | wc -l`"
printf "\n"
printf "'CVE-2009-3896 (0.1.0 - 0.8.13)'; `jq '.Agents[] | select(.Vendor=="nginx" and .CanonicalVersion >= "0000000100000000" and .CanonicalVersion <= "0000000800130000" and .Version != "") | .Version' $tmpName | wc -l`"
printf "\n"

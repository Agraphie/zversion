...
printf "Input file: $1\n"
printf '%s\n' '----------------------------------------------'
printf "'CVE-2014-0133 (1.3.15 - 1.5.11)'; `grep "nginx" $1 | jq '.Agents[] | select(.Vendor=="nginx" and .CanonicalVersion >= "0001000300150000" and .CanonicalVersion <= "0001000500110000" and .CanonicalVersion != "") | .Version' | wc -l`"
printf "\n"
printf "'CVE-2014-0088 (1.5.10)'; `grep "nginx" $1 | jq '.Agents[] | select(.Vendor=="nginx" and .CanonicalVersion == "0001000500100000" and .Version != "") | .Version' | wc -l`"
printf "\n"
...
printf "\n"
printf "'CVE-2009-3555 (0.1.0 - 0.8.22)'; `grep "nginx" $1 | jq '.Agents[] | select(.Vendor=="nginx" and .CanonicalVersion >= "0000000100000000" and .CanonicalVersion <= "0000000800220000" and .Version != "") | .Version' | wc -l`"
printf "\n"
printf "'CVE-2009-2629 (0.1.0 - 0.8.14)'; `grep "nginx" $1 | jq '.Agents[] | select(.Vendor=="nginx" and .CanonicalVersion >= "0000000100000000" and .CanonicalVersion <= "0000000800140000" and .Version != "") | .Version'  | wc -l`"
printf "\n"
